...
const PublicNav = () => [React.createElement("li", {
  id: "logInId",
  key: "login",
...
const SearchBar = () => React.createElement("form", {
...
const LoggedInNav = () => [React.createElement(SearchBar, {
  key: "searchbar"
...
class Profile extends React.Component {
  ...
  render() {
    const {
      loggedIn // remote example (if using ddp)
      // usersReady,
      // users,
      // countersReady,
      // counter,
...
module.exportDefault(withTracker(() => {
  ...
  */
  ...
  const counter = Counters.findOne({
    _id: Meteor.userId()
  });
...
const renderMergedProps = function (component) {
...
const RecoverPassword = () => React.createElement("div", {
...
const App = () => React.createElement("div", null, React.createElement(NavBar, null), React.createElement(Hello, null));
...
class Hello extends Component {
  ...
  addPreferences(event) {
    ...
    for (let i in arr) {
      ...
      Meteor.call('insertPreference', arr[i], error => {
        if (error) {
          console.log(erro);
        } else {
  ...
  render() {
    ...
    }), rend1 ? this.props.addedTrash.map(inst => {
      return inst;
    ...
    }), rend ? this.props.addedItems.map(inst => {
      return inst;
    }) : null), React.createElement(SaveAction, {
...
class TrashMail extends Component {
  render() {
...
const Modal = ($ => {
  ...
  class Modal {
    ...
    _resetScrollbar() {
      ...
      $("".concat(Selector.STICKY_CONTENT, ", ").concat(Selector.NAVBAR_TOGGLER)).each((index, element) => {
    ...
    static _jQueryInterface(config, relatedTarget) {
      return this.each(function () {
        ...
        const _config = (0, _objectSpread2.default)({}, Modal.Default, $(this).data(), typeof config === 'object' && config);
  ...
  $(document).on(Event.CLICK_DATA_API, Selector.DATA_TOGGLE, function (event) {
    ...
    const config = $(target).data(DATA_KEY) ? 'toggle' : (0, _objectSpread2.default)({}, $(target).data(), $(this).data());
...
const Routings = props => React.createElement(Router, null, React.createElement("div", null, React.createElement(PropsRoute, (0, _extends2.default)({
  component: Navbar
...
const store = createStore(rootReducer); // Subscription
